...
{   // Checks Success and Filters support for D3VP once per LUID
    ...
    public static VideoProcessorFilter[]        AllFilters      = (VideoProcessorFilter[])Enum.GetValues(typeof(VideoProcessorFilter));
    public static VideoProcessorFilterCaps[]    AllFilterCaps   = (VideoProcessorFilterCaps[])Enum.GetValues(typeof(VideoProcessorFilterCaps));
