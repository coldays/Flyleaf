    ...
    void ScreamerVASD()
    {
        ...
        while (status == Status.Playing)
        {
            ...
            if (requiresBuffering)
            {
                ...
                {
                    framesDisplayedDwmEnd   = (uint)renderer.GetFrameStatistics().PresentCount - framesDisplayedDwmStart;
                ...
                if (Config.Player.Stats)
                    framesDisplayedDwmStart = (uint)renderer.GetFrameStatistics().PresentCount;
        ...
        if (Config.Player.Stats)
        {
            ...
            framesDisplayedDwmEnd   = SafeSubstract((uint)renderer.GetFrameStatistics().PresentCount, framesDisplayedDwmStart);
            framesDisplayedDwm     += framesDisplayedDwmEnd;
            //Video.fpsCurrent        = 0;
            UI(() =>
            {
