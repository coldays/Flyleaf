...
unsafe partial class Player
{
    ...
    {   // Video and Data Only | IsLive | No Deinterlacing | No Frame Stepping | No Bitrate Stats | No Buffered Duration | Frame rate = receiving packets rate
        VideoDemuxer.Pause();
        VideoDecoder.Pause();
        ...
        while (status == Status.Playing)
        {
            ...
            {
                // TryGetFrame takes ownership of packet
